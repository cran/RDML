...
[![Travis-CI Build Status](https://travis-ci.org/kablag/RDML.svg?branch=master)](https://app.travis-ci.com/kablag/RDML)
...
Imports qPCR data from RDML v1.1 format files ([Lefever et al. 2009](https://doi.org/10.1093/nar/gkp056)) and 
transforms it to the appropriate format of the qpcR package (Ritz et al. 2008, Spiess et al. 2008) or chipPCR package. [RDML](http://rdml.org/) (Real-time PCR Data Markup 
Language) is the recommended file format element in the Minimum Information for 
Publication of Quantitative Real-Time PCR Experiments (MIQE) guidelines ([Bustin et al. 2009](https://doi.org/10.1373/clinchem.2008.112797)).
...
The manual is available [online](https://github.com/PCRuniversum/RDML).
